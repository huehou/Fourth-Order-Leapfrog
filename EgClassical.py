...
# print("The error for U3 is {}".format(errorU3))
# print("The error for U72 is {}".format(errorU72))
# print("The error for RK4 is {}".format(errorRK4))
# print("The error for U11 is {}".format(errorU11))
# print("The error for U7 is {}".format(errorU7))
